...
type RoleAccessRequestPayload struct {
	...
	RequestedBy     []byte               `protobuf:"bytes,7,opt,name=requested_by,json=requestedBy,proto3" json:"requested_by,omitempty"`
}
...
func (x *RoleAccessRequestPayload) GetGroup() string {
	if x != nil {
		return x.Group
	}
	return ""
...
type ApprovedRoleAccessRequestPayload struct {
	...
	//	*ApprovedRoleAccessRequestPayload_Window
	//	*ApprovedRoleAccessRequestPayload_Expires
	ProvisionStrategy isApprovedRoleAccessRequestPayload_ProvisionStrategy `protobuf_oneof:"provision_strategy"`
}
...
func (m *ApprovedRoleAccessRequestPayload) GetProvisionStrategy() isApprovedRoleAccessRequestPayload_ProvisionStrategy {
	if m != nil {
...
func (x *ApprovedRoleAccessRequestPayload) GetWindow() *Window {
	if x, ok := x.GetProvisionStrategy().(*ApprovedRoleAccessRequestPayload_Window); ok {
		return x.Window
	}
	return nil
}

func (x *ApprovedRoleAccessRequestPayload) GetExpires() *Expires {
	if x, ok := x.GetProvisionStrategy().(*ApprovedRoleAccessRequestPayload_Expires); ok {
		return x.Expires
	}
	return nil
}

type isApprovedRoleAccessRequestPayload_ProvisionStrategy interface {
	isApprovedRoleAccessRequestPayload_ProvisionStrategy()
}

type ApprovedRoleAccessRequestPayload_Window struct {
	Window *Window `protobuf:"bytes,3,opt,name=window,proto3,oneof"`
}

type ApprovedRoleAccessRequestPayload_Expires struct {
	Expires *Expires `protobuf:"bytes,4,opt,name=expires,proto3,oneof"`
}

func (*ApprovedRoleAccessRequestPayload_Window) isApprovedRoleAccessRequestPayload_ProvisionStrategy() {
}

func (*ApprovedRoleAccessRequestPayload_Expires) isApprovedRoleAccessRequestPayload_ProvisionStrategy() {
}
...
type Expires struct {
	...
	ApprovedSessionDuration *durationpb.Duration   `protobuf:"bytes,2,opt,name=approved_session_duration,json=approvedSessionDuration,proto3" json:"approved_session_duration,omitempty"`
}

func (x *Expires) Reset() {
	*x = Expires{}
	if protoimpl.UnsafeEnabled {
...
func (x *Expires) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Expires) ProtoMessage() {}

func (x *Expires) ProtoReflect() protoreflect.Message {
	mi := &file_certrail_v1alpha1_certrail_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Expires.ProtoReflect.Descriptor instead.
func (*Expires) Descriptor() ([]byte, []int) {
	return file_certrail_v1alpha1_certrail_proto_rawDescGZIP(), []int{6}
}

func (x *Expires) GetExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ExpiresAt
	}
	return nil
...
func (x *Expires) GetApprovedSessionDuration() *durationpb.Duration {
	if x != nil {
		return x.ApprovedSessionDuration
	}
	return nil
}
...
type IssueSessionCredentialsPayload struct {
	...
	RoleAccessRequestTrillianMerkleHash []byte `protobuf:"bytes,4,opt,name=role_access_request_trillian_merkle_hash,json=roleAccessRequestTrillianMerkleHash,proto3" json:"role_access_request_trillian_merkle_hash,omitempty"`
}
...
func (x *IssueSessionCredentialsPayload) GetRoleAccessRequestTrillianMerkleHash() []byte {
	if x != nil {
		return x.RoleAccessRequestTrillianMerkleHash
	}
	return nil
...
type OktaAccessWorkflowInitiatedPayload struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	InvocationArn   string `protobuf:"bytes,1,opt,name=invocation_arn,json=invocationArn,proto3" json:"invocation_arn,omitempty"`
	UserCertificate []byte `protobuf:"bytes,2,opt,name=user_certificate,json=userCertificate,proto3" json:"user_certificate,omitempty"`
	OktaGroup       string `protobuf:"bytes,3,opt,name=okta_group,json=oktaGroup,proto3" json:"okta_group,omitempty"`
	// Optionally, include the hash of the approval request if it exists that led to these credentials being granted
	RoleAccessRequestTrillianMerkleHash []byte `protobuf:"bytes,4,opt,name=role_access_request_trillian_merkle_hash,json=roleAccessRequestTrillianMerkleHash,proto3" json:"role_access_request_trillian_merkle_hash,omitempty"`
	UserSuppliedReason                  string `protobuf:"bytes,5,opt,name=user_supplied_reason,json=userSuppliedReason,proto3" json:"user_supplied_reason,omitempty"`
}

func (x *OktaAccessWorkflowInitiatedPayload) Reset() {
	*x = OktaAccessWorkflowInitiatedPayload{}
	if protoimpl.UnsafeEnabled {
...
func (x *OktaAccessWorkflowInitiatedPayload) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OktaAccessWorkflowInitiatedPayload) ProtoMessage() {}

func (x *OktaAccessWorkflowInitiatedPayload) ProtoReflect() protoreflect.Message {
	mi := &file_certrail_v1alpha1_certrail_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OktaAccessWorkflowInitiatedPayload.ProtoReflect.Descriptor instead.
func (*OktaAccessWorkflowInitiatedPayload) Descriptor() ([]byte, []int) {
	return file_certrail_v1alpha1_certrail_proto_rawDescGZIP(), []int{12}
}

func (x *OktaAccessWorkflowInitiatedPayload) GetInvocationArn() string {
	if x != nil {
		return x.InvocationArn
	}
	return ""
}

func (x *OktaAccessWorkflowInitiatedPayload) GetUserCertificate() []byte {
	if x != nil {
		return x.UserCertificate
	}
	return nil
...
func (x *OktaAccessWorkflowInitiatedPayload) GetOktaGroup() string {
	if x != nil {
		return x.OktaGroup
	}
	return ""
...
func (x *OktaAccessWorkflowInitiatedPayload) GetRoleAccessRequestTrillianMerkleHash() []byte {
	if x != nil {
		return x.RoleAccessRequestTrillianMerkleHash
	}
	return nil
...
func (x *OktaAccessWorkflowInitiatedPayload) GetUserSuppliedReason() string {
	if x != nil {
		return x.UserSuppliedReason
	}
	return ""
...
type Payload struct {
	...
	//	*Payload_OktaAccessWorkflowInitiated
...
func (x *Payload) GetOktaAccessWorkflowInitiated() *OktaAccessWorkflowInitiatedPayload {
	if x, ok := x.GetContents().(*Payload_OktaAccessWorkflowInitiated); ok {
		return x.OktaAccessWorkflowInitiated
	}
	return nil
}
...
type Payload_OktaAccessWorkflowInitiated struct {
	OktaAccessWorkflowInitiated *OktaAccessWorkflowInitiatedPayload `protobuf:"bytes,10,opt,name=okta_access_workflow_initiated,json=oktaAccessWorkflowInitiated,proto3,oneof"`
}
...
func (*Payload_OktaAccessWorkflowInitiated) isPayload_Contents() {}
...
type IncludedEnvelope struct {
	...
	Envelope           *Envelope `protobuf:"bytes,1,opt,name=envelope,proto3" json:"envelope,omitempty"`
	TrillianMerkleHash []byte    `protobuf:"bytes,2,opt,name=trillian_merkle_hash,json=trillianMerkleHash,proto3" json:"trillian_merkle_hash,omitempty"`
}
...
func (x *IncludedEnvelope) GetTrillianMerkleHash() []byte {
	if x != nil {
...
func (x *GetLatestSignedLogRootResponse) Reset() {
	*x = GetLatestSignedLogRootResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_certrail_v1alpha1_certrail_proto_msgTypes[21]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetLatestSignedLogRootResponse) Descriptor() ([]byte, []int) {
	return file_certrail_v1alpha1_certrail_proto_rawDescGZIP(), []int{21}
}
...
func (x *LogRoot) Reset() {
	*x = LogRoot{}
	if protoimpl.UnsafeEnabled {
		mi := &file_certrail_v1alpha1_certrail_proto_msgTypes[22]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LogRoot) Descriptor() ([]byte, []int) {
	return file_certrail_v1alpha1_certrail_proto_rawDescGZIP(), []int{22}
}
...
var file_certrail_v1alpha1_certrail_proto_rawDesc = []byte{
	...
	0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x22, 0x88, 0x02, 0x0a, 0x18, 0x52, 0x6f, 0x6c, 0x65, 0x41,
	...
	0x64, 0x65, 0x72, 0x12, 0x25, 0x0a, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x42, 0x0b, 0xfa, 0x42, 0x08, 0x72, 0x06, 0x98, 0x01, 0x0c, 0xd0, 0x01,
	0x01, 0x52, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x44, 0x0a, 0x10, 0x73, 0x65,
	...
	,
	...
	0x61, 0x31, 0x2e, 0x57, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x48, 0x00, 0x52, 0x06, 0x77, 0x69, 0x6e,
	0x64, 0x6f, 0x77, 0x12, 0x36, 0x0a, 0x07, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x63, 0x65, 0x72, 0x74, 0x72, 0x61, 0x69, 0x6c, 0x2e,
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x45, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73,
	0x48, 0x00, 0x52, 0x07, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x42, 0x14, 0x0a, 0x12, 0x70,
	0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67,
	0x79, 0x22, 0x68, 0x0a, 0x06, 0x57, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x12, 0x30, 0x0a, 0x05, 0x73,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d,
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x03, 0x65, 0x6e, 0x64, 0x22, 0x9b, 0x01, 0x0a, 0x07,
	0x45, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x12, 0x39, 0x0a, 0x0a, 0x65, 0x78, 0x70, 0x69, 0x72,
	...
	,
	...
	0x61, 0x74, 0x65, 0x22, 0x5b, 0x0a, 0x18, 0x52, 0x65, 0x76, 0x6f, 0x6b, 0x65, 0x43, 0x65, 0x72,
	...
	,
	...
	,
	...
	0x74, 0x22, 0x57, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x45, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x41, 0x0a, 0x09, 0x65, 0x6e, 0x76, 0x65, 0x6c,
	0x6f, 0x70, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x63, 0x65, 0x72,
	0x74, 0x72, 0x61, 0x69, 0x6c, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x49,
	0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x64, 0x45, 0x6e, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x65, 0x52,
	0x09, 0x65, 0x6e, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x65, 0x73, 0x22, 0x7d, 0x0a, 0x10, 0x49, 0x6e,
	0x63, 0x6c, 0x75, 0x64, 0x65, 0x64, 0x45, 0x6e, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x65, 0x12, 0x37,
	...
	,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0xdd, 0x01, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x65,
	0x72, 0x74, 0x72, 0x61, 0x69, 0x6c, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x42,
	0x0d, 0x43, 0x65, 0x72, 0x74, 0x72, 0x61, 0x69, 0x6c, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01,
	...
	,
...
var file_certrail_v1alpha1_certrail_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_certrail_v1alpha1_certrail_proto_goTypes = []interface{}{
	...
	(*Window)(nil),                             // 5: certrail.v1alpha1.Window
	(*Expires)(nil),                            // 6: certrail.v1alpha1.Expires
	(*DeclinedRoleAccessRequestPayload)(nil),   // 7: certrail.v1alpha1.DeclinedRoleAccessRequestPayload
	(*CancelledRoleAccessRequestPayload)(nil),  // 8: certrail.v1alpha1.CancelledRoleAccessRequestPayload
	(*IssueCertificatePayload)(nil),            // 9: certrail.v1alpha1.IssueCertificatePayload
	(*RevokeCertificatePayload)(nil),           // 10: certrail.v1alpha1.RevokeCertificatePayload
	(*IssueSessionCredentialsPayload)(nil),     // 11: certrail.v1alpha1.IssueSessionCredentialsPayload
	(*OktaAccessWorkflowInitiatedPayload)(nil), // 12: certrail.v1alpha1.OktaAccessWorkflowInitiatedPayload
	(*Envelope)(nil),                           // 13: certrail.v1alpha1.Envelope
	(*Payload)(nil),                            // 14: certrail.v1alpha1.Payload
	(*StoreRequest)(nil),                       // 15: certrail.v1alpha1.StoreRequest
	(*StoreResponse)(nil),                      // 16: certrail.v1alpha1.StoreResponse
	(*GetEntriesRequest)(nil),                  // 17: certrail.v1alpha1.GetEntriesRequest
	(*GetEntriesResponse)(nil),                 // 18: certrail.v1alpha1.GetEntriesResponse
	(*IncludedEnvelope)(nil),                   // 19: certrail.v1alpha1.IncludedEnvelope
	(*GetLatestSignedLogRootRequest)(nil),      // 20: certrail.v1alpha1.GetLatestSignedLogRootRequest
	(*GetLatestSignedLogRootResponse)(nil),     // 21: certrail.v1alpha1.GetLatestSignedLogRootResponse
	(*LogRoot)(nil),                            // 22: certrail.v1alpha1.LogRoot
	(*durationpb.Duration)(nil),                // 23: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),              // 24: google.protobuf.Timestamp
}
var file_certrail_v1alpha1_certrail_proto_depIdxs = []int32{
	23, // 0: certrail.v1alpha1.RoleAccessRequestPayload.session_duration:type_name -> google.protobuf.Duration
	5,  // 1: certrail.v1alpha1.ApprovedRoleAccessRequestPayload.window:type_name -> certrail.v1alpha1.Window
	6,  // 2: certrail.v1alpha1.ApprovedRoleAccessRequestPayload.expires:type_name -> certrail.v1alpha1.Expires
	24, // 3: certrail.v1alpha1.Window.start:type_name -> google.protobuf.Timestamp
	24, // 4: certrail.v1alpha1.Window.end:type_name -> google.protobuf.Timestamp
	24, // 5: certrail.v1alpha1.Expires.expires_at:type_name -> google.protobuf.Timestamp
	23, // 6: certrail.v1alpha1.Expires.approved_session_duration:type_name -> google.protobuf.Duration
	14, // 7: certrail.v1alpha1.Envelope.payload:type_name -> certrail.v1alpha1.Payload
	24, // 8: certrail.v1alpha1.Payload.timestamp:type_name -> google.protobuf.Timestamp
	0,  // 9: certrail.v1alpha1.Payload.approve_config:type_name -> certrail.v1alpha1.ApproveConfigPayload
	9,  // 10: certrail.v1alpha1.Payload.issue_certificate:type_name -> certrail.v1alpha1.IssueCertificatePayload
	10, // 11: certrail.v1alpha1.Payload.revoke_certificate:type_name -> certrail.v1alpha1.RevokeCertificatePayload
	11, // 12: certrail.v1alpha1.Payload.issue_session_credentials:type_name -> certrail.v1alpha1.IssueSessionCredentialsPayload
	3,  // 13: certrail.v1alpha1.Payload.role_access_request:type_name -> certrail.v1alpha1.RoleAccessRequestPayload
	4,  // 14: certrail.v1alpha1.Payload.approved_role_access_request:type_name -> certrail.v1alpha1.ApprovedRoleAccessRequestPayload
	7,  // 15: certrail.v1alpha1.Payload.declined_role_access_request:type_name -> certrail.v1alpha1.DeclinedRoleAccessRequestPayload
	8,  // 16: certrail.v1alpha1.Payload.cancelled_role_access_request:type_name -> certrail.v1alpha1.CancelledRoleAccessRequestPayload
	12, // 17: certrail.v1alpha1.Payload.okta_access_workflow_initiated:type_name -> certrail.v1alpha1.OktaAccessWorkflowInitiatedPayload
	13, // 18: certrail.v1alpha1.StoreRequest.envelope:type_name -> certrail.v1alpha1.Envelope
	19, // 19: certrail.v1alpha1.GetEntriesResponse.envelopes:type_name -> certrail.v1alpha1.IncludedEnvelope
	13, // 20: certrail.v1alpha1.IncludedEnvelope.envelope:type_name -> certrail.v1alpha1.Envelope
	22, // 21: certrail.v1alpha1.GetLatestSignedLogRootResponse.log_root:type_name -> certrail.v1alpha1.LogRoot
	24, // 22: certrail.v1alpha1.LogRoot.timestamp:type_name -> google.protobuf.Timestamp
	15, // 23: certrail.v1alpha1.CertrailService.Store:input_type -> certrail.v1alpha1.StoreRequest
	17, // 24: certrail.v1alpha1.CertrailService.GetEntries:input_type -> certrail.v1alpha1.GetEntriesRequest
	1,  // 25: certrail.v1alpha1.CertrailService.GetEntryIndexByMerkleHash:input_type -> certrail.v1alpha1.GetEntryIndexByMerkleHashRequest
	20, // 26: certrail.v1alpha1.CertrailService.GetLatestSignedLogRoot:input_type -> certrail.v1alpha1.GetLatestSignedLogRootRequest
	16, // 27: certrail.v1alpha1.CertrailService.Store:output_type -> certrail.v1alpha1.StoreResponse
	18, // 28: certrail.v1alpha1.CertrailService.GetEntries:output_type -> certrail.v1alpha1.GetEntriesResponse
	2,  // 29: certrail.v1alpha1.CertrailService.GetEntryIndexByMerkleHash:output_type -> certrail.v1alpha1.GetEntryIndexByMerkleHashResponse
	21, // 30: certrail.v1alpha1.CertrailService.GetLatestSignedLogRoot:output_type -> certrail.v1alpha1.GetLatestSignedLogRootResponse
...
func file_certrail_v1alpha1_certrail_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_certrail_v1alpha1_certrail_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OktaAccessWorkflowInitiatedPayload); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_certrail_v1alpha1_certrail_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
		...
		file_certrail_v1alpha1_certrail_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
	...
	file_certrail_v1alpha1_certrail_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*ApprovedRoleAccessRequestPayload_Window)(nil),
		(*ApprovedRoleAccessRequestPayload_Expires)(nil),
	}
	file_certrail_v1alpha1_certrail_proto_msgTypes[14].OneofWrappers = []interface{}{
		...
		(*Payload_OktaAccessWorkflowInitiated)(nil),
	}
	file_certrail_v1alpha1_certrail_proto_msgTypes[16].OneofWrappers = []interface{}{
