...
func (msg *StoreAssumeRoleReasonRequest) MarshalJSON() ([]byte, error) {
...
func (msg *StoreAssumeRoleReasonRequest) UnmarshalJSON(b []byte) error {
...
// MarshalJSON implements json.Marshaler
func (msg *StoreAssumeRoleReasonResponse) MarshalJSON() ([]byte, error) {
	return protojson.MarshalOptions{
		UseEnumNumbers:  false,
		EmitUnpopulated: false,
		UseProtoNames:   false,
...
// UnmarshalJSON implements json.Unmarshaler
func (msg *StoreAssumeRoleReasonResponse) UnmarshalJSON(b []byte) error {
	return protojson.UnmarshalOptions{
		DiscardUnknown: false,
	}.Unmarshal(b, msg)
}
