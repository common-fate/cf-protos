...
// Validate checks the field values on RotateTenantCertificateRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *RotateTenantCertificateRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on RotateTenantCertificateRequest with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// RotateTenantCertificateRequestMultiError, or nil if none found.
func (m *RotateTenantCertificateRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *RotateTenantCertificateRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// RotateTenantCertificateRequestMultiError is an error wrapping multiple
// validation errors returned by RotateTenantCertificateRequest.ValidateAll()
// if the designated constraints aren't met.
type RotateTenantCertificateRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m RotateTenantCertificateRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m RotateTenantCertificateRequestMultiError) AllErrors() []error { return m }

// RotateTenantCertificateRequestValidationError is the validation error
// returned by RotateTenantCertificateRequest.Validate if the designated
// constraints aren't met.
type RotateTenantCertificateRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e RotateTenantCertificateRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e RotateTenantCertificateRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e RotateTenantCertificateRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e RotateTenantCertificateRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e RotateTenantCertificateRequestValidationError) ErrorName() string {
	return "RotateTenantCertificateRequestValidationError"
}

// Error satisfies the builtin error interface
func (e RotateTenantCertificateRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sRotateTenantCertificateRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = RotateTenantCertificateRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = RotateTenantCertificateRequestValidationError{}

// Validate checks the field values on RotateTenantCertificateResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *RotateTenantCertificateResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on RotateTenantCertificateResponse with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// RotateTenantCertificateResponseMultiError, or nil if none found.
func (m *RotateTenantCertificateResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *RotateTenantCertificateResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// RotateTenantCertificateResponseMultiError is an error wrapping multiple
// validation errors returned by RotateTenantCertificateResponse.ValidateAll()
// if the designated constraints aren't met.
type RotateTenantCertificateResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m RotateTenantCertificateResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m RotateTenantCertificateResponseMultiError) AllErrors() []error { return m }

// RotateTenantCertificateResponseValidationError is the validation error
// returned by RotateTenantCertificateResponse.Validate if the designated
// constraints aren't met.
type RotateTenantCertificateResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e RotateTenantCertificateResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e RotateTenantCertificateResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e RotateTenantCertificateResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e RotateTenantCertificateResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e RotateTenantCertificateResponseValidationError) ErrorName() string {
	return "RotateTenantCertificateResponseValidationError"
}

// Error satisfies the builtin error interface
func (e RotateTenantCertificateResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sRotateTenantCertificateResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = RotateTenantCertificateResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = RotateTenantCertificateResponseValidationError{}
