...
var file_team_v1alpha1_team_proto_rawDesc = []byte{
	...
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x32, 0x8c,
	0x02, 0x0a, 0x0b, 0x54, 0x65, 0x61, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x54,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0xbd, 0x01,
...
var file_team_v1alpha1_team_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_team_v1alpha1_team_proto_goTypes = []interface{}{
	...
	(*v1alpha1.Config)(nil),      // 7: gconfig.v1alpha1.Config
}
var file_team_v1alpha1_team_proto_depIdxs = []int32{
	...
	7, // 1: team.v1alpha1.UpdateConfigRequest.config:type_name -> gconfig.v1alpha1.Config
	7, // 2: team.v1alpha1.GetConfigResponse.config:type_name -> gconfig.v1alpha1.Config
	0, // 3: team.v1alpha1.TeamService.ListMembers:input_type -> team.v1alpha1.ListMembersRequest
	3, // 4: team.v1alpha1.TeamService.UpdateConfig:input_type -> team.v1alpha1.UpdateConfigRequest
	5, // 5: team.v1alpha1.TeamService.GetConfig:input_type -> team.v1alpha1.GetConfigRequest
	1, // 6: team.v1alpha1.TeamService.ListMembers:output_type -> team.v1alpha1.ListMembersResponse
	4, // 7: team.v1alpha1.TeamService.UpdateConfig:output_type -> team.v1alpha1.UpdateConfigResponse
	6, // 8: team.v1alpha1.TeamService.GetConfig:output_type -> team.v1alpha1.GetConfigResponse
