...
import (
	v1alpha1 "github.com/common-fate/gconfig/gconfig/v1alpha1"
...
var file_team_v1alpha1_team_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x68, 0x32, 0xbc, 0x01, 0x0a, 0x0b, 0x54, 0x65, 0x61, 0x6d, 0x53, 0x65, 0x72, 0x76,
...
var file_team_v1alpha1_team_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_team_v1alpha1_team_proto_goTypes = []interface{}{
	...
	(*v1alpha1.Config)(nil),      // 5: gconfig.v1alpha1.Config
}
var file_team_v1alpha1_team_proto_depIdxs = []int32{
	...
	5, // 1: team.v1alpha1.UpdateConfigRequest.config:type_name -> gconfig.v1alpha1.Config
	0, // 2: team.v1alpha1.TeamService.ListMembers:input_type -> team.v1alpha1.ListMembersRequest
	3, // 3: team.v1alpha1.TeamService.UpdateConfig:input_type -> team.v1alpha1.UpdateConfigRequest
	1, // 4: team.v1alpha1.TeamService.ListMembers:output_type -> team.v1alpha1.ListMembersResponse
	4, // 5: team.v1alpha1.TeamService.UpdateConfig:output_type -> team.v1alpha1.UpdateConfigResponse
