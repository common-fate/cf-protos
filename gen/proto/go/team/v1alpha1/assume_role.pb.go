...
var File_team_v1alpha1_assume_role_proto protoreflect.FileDescriptor

var file_team_v1alpha1_assume_role_proto_rawDesc = []byte{
	0x0a, 0x1f, 0x74, 0x65, 0x61, 0x6d, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2f,
...
var (
	file_team_v1alpha1_assume_role_proto_rawDescOnce sync.Once
	file_team_v1alpha1_assume_role_proto_rawDescData = file_team_v1alpha1_assume_role_proto_rawDesc
)

func file_team_v1alpha1_assume_role_proto_rawDescGZIP() []byte {
	file_team_v1alpha1_assume_role_proto_rawDescOnce.Do(func() {
		file_team_v1alpha1_assume_role_proto_rawDescData = protoimpl.X.CompressGZIP(file_team_v1alpha1_assume_role_proto_rawDescData)
	})
...
func init() { file_team_v1alpha1_assume_role_proto_init() }
func file_team_v1alpha1_assume_role_proto_init() {
	if File_team_v1alpha1_assume_role_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_team_v1alpha1_assume_role_proto_goTypes,
		DependencyIndexes: file_team_v1alpha1_assume_role_proto_depIdxs,
		MessageInfos:      file_team_v1alpha1_assume_role_proto_msgTypes,
	}.Build()
	File_team_v1alpha1_assume_role_proto = out.File
	file_team_v1alpha1_assume_role_proto_rawDesc = nil
	file_team_v1alpha1_assume_role_proto_goTypes = nil
	file_team_v1alpha1_assume_role_proto_depIdxs = nil
}
